...
public class OrderEventKafkaListener {
    ...
    public void listenOrderReadyForDelivery(ConsumerRecord<String, OrderReadyForDeliveryEvent> record) {
    ...
    private String getEventType(ConsumerRecord<String, OrderReadyForDeliveryEvent> record) {
